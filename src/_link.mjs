const year = '2024',
    _link = {
        home: { nav: 'home', tip: 'overview, updates and entry link' },
        info: { nav: 'details', tip: 'detailed event information' },
        results: { nav: 'results', tip: 'previous results' },
        ...
        contact: { popup: 'Contact', img: 'email', tip: 'contact us', placement: 'bottom-end' },
        user: { popup: 'User', img: 'user', tip: 'user', placement: 'bottom-end' },
