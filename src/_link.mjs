const year = '2024',
    _link = {
        home_: { href: 'home', tip: 'overview, updates and entry link' },
        info_: { href: 'details', tip: 'detailed event information' },
        results_: { href: 'results', tip: 'previous results' },
        volunteer_: { text: 'Volunteer', hide: true, href: 'volunteer', tip: 'volunteer system' },
        admin_: { text: 'Admin', page: () => apage('email'), hide: true, href: 'admin', tip: 'data admin' },
        competitor_: { text: 'Competitor', hide: true, href: 'competitor', tip: 'entry system' },
        contact_: { popup: 'Contact', img: 'email', tip: 'contact us', placement: 'bottom-end' },
        user_: { popup: 'User', img: 'user', tip: 'user', placement: 'bottom-end' },
        ...
        jetlogo: { img: 'jet', tip: 'Jetstream Triathlon Club website', href: 'https://jetstreamtri.com' },
